  ...
  return (
    <header className="sticky top-0 z-40 bg-[#111] text-white border-b border-black/40">
      <div className="w-full relative">
        {/* ===== Desktop logo at far-left edge ===== */}
        <Link
          to="/"
          aria-label="Travella Home"
          className="hidden md:inline-flex items-center absolute left-3 top-1/2 -translate-y-1/2 shrink-0"
        >
          <img
            src={logoSrc}
            alt="Travella"
        ...
        {/* Main centered container (shifted right so it doesn't overlap logo) */}
        <div className="mx-auto max-w-7xl px-3 sm:px-4 md:pl-28">
          ...
          <div className="h-14 flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 min-w-0">
              <button
                ...
                className="md:hidden inline-flex items-center justify-center w-9 h-9 rounded-lg hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-orange-400 shrink-0"
                aria-label="Menu"
              >
                {mobileOpen ? <IconClose /> : <IconBurger />}
              </button>

              {/* ===== Mobile logo (kept inside flow) ===== */}
              <Link to="/" className="md:hidden inline-flex items-center shrink-0" aria-label="Travella Home">
                <img
                  src={logoSrc}
                  alt="Travella"
              ...
              {isAdmin && (
                <div className="hidden md:block relative ml-1 shrink-0" ref={adminRef}>
                  <button
                    type="button"

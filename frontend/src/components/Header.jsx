...
export default function Header() {
  ...
  // если позже захочешь отдельный лого для India — поменяешь тут
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#111] text-white border-b border-black/40">
      {/* делаем контейнер без лишних отступов, чтобы лого ушёл максимально влево */}
      <div className="mx-auto max-w-7xl px-1 sm:px-2 md:px-3">
        <div className="h-14 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            {/* LOGO — фиксируем, чтобы не “уезжал/прятался” при длинных RU/UZ названиях */}
            <Link
              to="/"
              className="inline-flex items-center shrink-0 mr-2 -ml-1 sm:-ml-2 md:-ml-3"
            ...
            {/* Products + Admin (desktop). Делаем полосу скроллимой, чтобы кнопки не наезжали */}
            <div className="hidden md:flex items-center gap-1 min-w-0">
              ...
              {isAdmin && (
                <div className="relative ml-1 shrink-0" ref={adminRef}>
                  <button
                    type="button"

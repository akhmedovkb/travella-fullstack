    ...
    const fetchCounts = async () => {
      ...
      try {
        ...
        try {
          ...
          if (bs && bs.pending != null) bookingsPending = Number(bs.pending ?? 0);
          else if (bs && bs.awaiting != null) bookingsPending = Number(bs.awaiting ?? 0);
          else if (bs && bs.new != null) bookingsPending = Number(bs.new ?? 0);
        } catch {
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-4">
        ...
        <div className="h-14 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* LOGO */}
            <Link to="/" className="inline-flex items-center mr-1" aria-label="Travella Home">
              <img
                src="/logo1.jpg"
                alt="Travella"

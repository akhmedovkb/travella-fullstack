...
export default function ClientDashboard() {
  ...
  // Sync activeTab when the URL query (?tab=...) changes externally (e.g., top navbar link)
  useEffect(() => {
  ...
  // Also support hash navigation like #favorites
  useEffect(() => {
    const h = (location.hash || "").replace("#", "");
    if (h === "favorites" && activeTab !== "favorites") {

  ...
  <>
    ...
    <div className="flex gap-4 mb-2">
      ...
      <Select
        ...
        value={cityOptionsTo.find(c => c.value === details.directionTo)}
        onChange={(value) =>
    ...
    <div className="flex gap-4 mb-2">
      <div className="w-1/2">
        ...
        <input
          ...
          onChange={(e) =>
            setDetails({ ...details, startFlightDate: e.target.value })
          }
      ...
      <div className="w-1/2">
        ...
        <input
          ...
          onChange={(e) =>
            setDetails({ ...details, endFlightDate: e.target.value })
          }
          className="w-full border px-3 py-2 rounded"
        />
      </div>
    ...
    <div className="mb-2">
      ...
      <label className="inline-flex items-center mt-2">
        <input
          ...
          onChange={(e) =>
            setDetails({ ...details, halal: e.target.checked })
          }
          className="mr-2"
        />

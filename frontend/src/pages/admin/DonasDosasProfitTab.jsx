// frontend/src/pages/admin/DonasDosasProfitTab.jsx
...
export default function DonasDosasProfitTab() {
  ...
  return (
    <div className="rounded-2xl bg-white border border-gray-200 p-5 space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div>
          <div className="text-xl font-semibold">Profit / Margin</div>
          <div className="text-sm text-gray-600">Цена продажи, COGS и маржа по рецепту</div>
        </div>
        <button
          type="button"

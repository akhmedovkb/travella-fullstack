...
// === Booking Conveyor ===
router.post("/:id/check-availability", authenticateToken, requireProvider, checkAvailability);
router.post("/:id/place-hold", authenticateToken, requireProvider, placeHold);

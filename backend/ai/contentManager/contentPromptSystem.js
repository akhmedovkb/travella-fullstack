  ...
  const items = [
    ...
    },
    {
      ...
      text: lines([
        ...
        codeLine,
        "",
        "Предложение отказное и может быстро стать неактуальным. Для бронирования нажмите кнопку «Связаться с поставщиком» под видео. Контакты откроются после оплаты в боте.",
      ]),
    },
    {
      id: "reels_title",
